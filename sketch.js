...
function preload()
{
  ...
  soldierHitSound = loadSound("sounds/soldierHitsRobot-2.mp3")
...
function draw() {
  ...
  if (gameState === "start")
  {
    ...
    text("Five first aid kits will be equal to one life",20,80)
    text("If you kill a robot with bullet you will get 5 points",20,120)
    text("If you kill a UFO with bullet you will get 1o points",20,160)
    text("Press SPACE KEY to jump",20,200)
    text("Press RIGHT ARROW KEY to release a bullet",20,240)
    text("Press DOWN ARROW to make the soldier sit and then hit a UFO or robot",20,280)
    text("Press RESET button to restart the game",20,320)
